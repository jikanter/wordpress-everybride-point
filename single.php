		...
		<article class="article">		
			<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
              ...
              <!-- <a href="http://www.pinterest.com/pin/create/button/
                      ?url=http%3A%2F%2Fwww.theeverbride.com%2F
                      &media=http%3A%2F%2Fwww.theeverybride.com%2Fwp-content%2Fuploads%2F2014%2F10%2Fthe-every-bride_086-300x76.png
                      &description=The%20Every%3A%20Bride"
                      data-pin-do="buttonPin"
                      data-pin-config="above">
                      <img src="//assets.pinterest.com/images/pidgets/pin_it_button.png" />
              </a> -->
              <!-- <a href="http://www.pinterest.com/pin/create/button/
                                      ?url=http%3A%2F%2Fdev.theeverybride.com?post_id=<?php the_ID(); ?>
                                      &media=<?php echo str_replace(':', '%3A', str_replace('/', '%2F', wp_get_attachment_image_src( get_post_thumbnail_id( the_ID() ), 'large' )[0] ) ); ?>
                                      &description=The%20Every%3A%20Bride"
                                      data-pin-do="buttonPin"
                                      data-pin-config="above">
                                      <img src="//assets.pinterest.com/images/pidgets/pin_it_button.png" />
              </a>  -->
              <div class="fb-follow" data-href="https://www.facebook.com/theeverybrides" data-width="10" data-height="10" data-colorscheme="light" data-layout="standard" data-show-faces="true"></div>
              <span class="ig-follow" data-id="6273a3e82a" data-count="true" data-size="small" data-username="true"></span>
              <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
              <!-- EveryBride -->
              <ins class="adsbygoogle"
                   style="display:inline-block;width:728px;height:90px"
                   data-ad-client="ca-pub-9867912179558900"
                   data-ad-slot="5829486476"></ins>
              <script>
